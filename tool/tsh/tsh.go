...
// readClusterFlag reads in cluster from the OS environment. Supports reading
// in legacy TELEPORT_SITE as well as new TELEPORT_CLUSTER. TELEPORT_CLUSTER
// is prefered if both are set.
